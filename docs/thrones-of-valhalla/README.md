# Thrones Of Valhalla Design Docs

This folder contains the permanent design documentation for the Thrones of Valhalla server gameplay loop, Realm progression, Raven tracking philosophy, and legacy systems.

These docs are the source of truth for future Raven bot implementation work. They describe what the server should support and what the Raven should remember, but they do not define or implement bot commands yet.
...
- [Raven Product Architecture](RAVEN_PRODUCT_ARCHITECTURE.md): high-level architecture for the Raven as a lightweight MMO game master layered over Valheim.
...
Valheim comes first. The Thrones layer should create stories, shared milestones, and durable Realm history without turning normal play into chores or paperwork.
